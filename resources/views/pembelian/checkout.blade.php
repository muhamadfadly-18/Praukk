...
$(document).ready(function () {
    ...
    if (no_hp.length >= 10) {
        // Jika nomor HP diisi, langsung pindah ke halaman members tanpa menyimpan ke database
        window.location.href = '/members?' + queryString;
    } else {
        // Jika nomor HP tidak diisi, baru simpan data ke database lalu pindah ke halaman struk
        $.ajax({
