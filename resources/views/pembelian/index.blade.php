...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#detailpembelianModal{{ $pro->id }}">
                                            Lihat Detail
                                        </button>
    ...
    @foreach ($pembelian as $pro)
        <div class="modal fade" id="detailpembelianModal{{ $pro->id }}" tabindex="-1"
            aria-labelledby="detailpembelianModalLabel{{ $pro->id }}" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p><strong>Status:</strong> {{ $pro->member && $pro->member->name ? 'Members' : 'No Members' }}
                        </p>
                        ...
                        <h5 class="text-end mt-3"><strong>Total:</strong> Rp.
                            {{ number_format($pro->total_harga ?? 0, 0, ',', '.') }}</h5>
...
@push('scripts')
    <script>
        ...
        document.getElementById('searchInput').addEventListener('keyup', function () {
            ...
            var rows = document.querySelectorAll('#pembelianTable tbody tr');
