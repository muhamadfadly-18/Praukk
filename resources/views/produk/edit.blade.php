<div class="modal fade" id="editProdukModal{{ $pro->id }}" tabindex="-1" aria-labelledby="editProdukModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('produk.update', $pro->id) }}" method="POST" enctype="multipart/form-data"
                    onsubmit="return confirmUpdate(event, this)">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="hargaBeli{{ $pro->id }}" name="harga_beli"
                                class="form-control" value="{{ number_format($pro->harga_beli, 0, ',', '.') }}"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="stock" class="form-control" value="{{ $pro->stock }}" readonly>
                    </div>
